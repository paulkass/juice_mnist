...
juice_mnist train <batch> <hidden> [<file>]
...
fn train_dataset(batch_size: Option<usize>, hidden_layer_size: Option<usize>, file: Option<String>) -> Result<(), Error> {
...
fn main() -> Result<(), Error> {
    ...
    if args.cmd_download {
        ...
        train_dataset(args.arg_batch, args.arg_hidden, args.arg_file)?;
    }
